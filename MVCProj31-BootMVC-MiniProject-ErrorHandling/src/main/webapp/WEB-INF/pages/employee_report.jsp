       ...
       <table align="center" border="1"  bgcolor="cyan" >
          ...
          <c:forEach var="emp" items="${empsList}">
              <tr>
                ...
                <td> ${emp.job} </td>
                <td> ${emp.sal} </td>
                <td> <a href="employee_edit?eno=${emp.empno}"> <img src="images/edit.png" width="50" height="50"></a>  </td>
                 <td> <a href="employee_delete?eno=${emp.empno}" onclick="return confirm('Are sure to Delete?')"> <img src="images/delete.png" width="50" height="50"></a>  </td> 
              </tr>
          </c:forEach>
