...
public class EmployeeDAOImpl implements IEmployeeDAO {
	...
	private static  final String GET_EMP_BY_ENO_QUERY="SELECT EMPNO,ENAME,JOB,SAL FROM EMP WHERE EMPNO=?";
	private static  final String UPDATE_EMP_BY_ENO="UPDATE EMP SET ENAME=?,JOB=?,SAL=? WHERE EMPNO=?";
	private static  final String DELETE_EMP_BY_ENO="DELETE FROM EMP  WHERE EMPNO=?";
	...
	public int deleteEmployeeByEno(int eno) {
		int count=jt.update(DELETE_EMP_BY_ENO,eno);
		return count;
	}
